...
namespace Modules\AlvaTrips\Http\Controllers\Frontend;
...
class IndexController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('alvatrips::index', ['trips' => $trips]);
    }
    ...
    {
        return view('alvatrips::create', ['airlines' => $this->airlineRepo->selectBoxList(true)]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return to_route('alvatrips.show', ['trip' => $tr->id]);
    }

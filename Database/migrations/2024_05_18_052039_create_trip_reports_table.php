...
class CreateTripReportsTable extends Migration
{
    ...
    public function up()
    {
        if (!Schema::hasTable('alva_trip_reports')) {
            Schema::create('alva_trip_reports', function (Blueprint $table) {
                $table->string('id');
        ...
        if (!Schema::hasTable('alva_flight_pirep_trip')) {
            Schema::create('alva_flight_pirep_trip', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::dropIfExists('alva_trip_reports');
        Schema::dropIfExists('alva_flight_pirep_trip');
